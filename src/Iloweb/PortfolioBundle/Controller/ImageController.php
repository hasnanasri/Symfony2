...
use Iloweb\PortfolioBundle\Form\ImageType;
...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IlowebPortfolioBundle:Image')->findAll();

        return $this->render('IlowebPortfolioBundle:Image:index.html.twig', array(
            'entities' => $entities
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IlowebPortfolioBundle:Image')->find($id);
        ...
        return $this->render('IlowebPortfolioBundle:Image:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('IlowebPortfolioBundle:Image:edit.html.twig', array(
            'entity'      => $entity,
